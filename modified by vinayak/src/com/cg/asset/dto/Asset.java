...
public class Asset {
	...
	public Asset(int allocationId, int assetId, int empNo, String assetName, String assetDes, int quantity,int allocatedQuantity,String status,int mgrId,String employeeName,String departmentName) {
		super();
		this.allocationId = allocationId;
		this.assetId = assetId;
		this.empNo = empNo;
